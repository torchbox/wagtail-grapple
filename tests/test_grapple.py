...
class PagesTest(BaseGrappleTest):
    ...
    def test_pages(self):
        ...
        self.assertEquals(pages_data[0]["contentType"], "testapp.HomePage")
        self.assertEquals(pages_data[0]["pageType"], "HomePage")
        self.assertEquals(pages_data[1]["contentType"], "testapp.BlogPage")
    ...
    def test_page(self):
        ...
        self.assertEquals(page_data["contentType"], "testapp.BlogPage")
        self.assertEquals(page_data["parent"]["contentType"], "testapp.HomePage")
...
class SitesTest(TestCase):
    ...
    def test_site_pages_content_type_filter(self):
        ...
        self.assertEquals(data[0]["contentType"], "testapp.HomePage")
        ...
        data = results["data"]["site"]["pages"]
        self.assertEquals(len(data), 1)
        self.assertEquals(data[0]["contentType"], "testapp.BlogPage")
